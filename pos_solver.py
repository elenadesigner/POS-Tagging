    ...
    def hmm(self, sentence):
        ...
        for idx, pos_type in enumerate(self.prior.keys()):
            ...
            if sentence[0] in self.emission_probabilities[pos_type]:
                veterbi[0][pos_type] = self.pos_init_probabilities[pos_type] * self.emission_probabilities[pos_type][
                    word]
            else:
        ...
        for index in range(1, len(sentence)):
            ...
            for idx, pos_type in enumerate(self.prior.keys()):
                for idx1, pos_type1 in enumerate(self.prior.keys()):
                    ...
                    prob_values.append(
                        veterbi[index - 1][pos_type1] * self.pos_transition_probabilities[pos_type1][pos_type])
                if word in self.emission_probabilities[pos_type]:
